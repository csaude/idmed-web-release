...
ALTER TABLE IF EXISTS external_patient_visit ALTER COLUMN json_object TYPE text COLLATE pg_catalog."default";
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_sequences WHERE schemaname = 'public' AND sequencename = 'hibernate_sequence') THEN
        CREATE SEQUENCE hibernate_sequence START WITH 23145 INCREMENT BY 1;
    END IF;
END 
$$;
