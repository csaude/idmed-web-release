...
# October 21th, 2022
# Update Dec 2nd, 2024
bucardo -h db -U bucardo add table clinical_service_clinic_sector db=main relgroup=idmed_relgroup
bucardo -h db -U bucardo add customcols clinical_service_clinic_sector "SELECT clinical_service_clinic_sectors_id,clinic_sector_id" db=main
...
bucardo -h db -U bucardo add table stock_level db=main relgroup=idmed_relgroup
...
bucardo -h db -U bucardo add table external_patient_visit db=main relgroup=idmed_relgroup
